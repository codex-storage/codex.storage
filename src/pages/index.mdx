...
<Hero size="large" verticalAlign="center">
  <HeroInfo hideScrollToBottom>
    ...
    <HeroDescription>
      Codex is a durable, decentralised storage protocol designed to safeguard the world's most valuable information. Read the whitepaper and join the testnet to help secure a resilient digital future
    </HeroDescription>
    <HeroActions>
      <HeroAction href="https://discord.gg/codex-storage" target="_blank">
        Join testnet
      </HeroAction>
      <HeroAction href="https://docs.codex.storage/learn/whitepaper " target="_blank">
        Read Whitepaper
      </HeroAction>
    </HeroActions>
  </HeroInfo>
