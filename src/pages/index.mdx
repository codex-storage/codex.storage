...
<Hero size="large" verticalAlign="center">
  <HeroInfo hideScrollToBottom>
    ...
    <HeroDescription>
      Codex is a durable, decentralised storage protocol designed to safeguard the world's most valuable information. Read the whitepaper and download the testnet to help secure a resilient digital future.
    </HeroDescription>
    <HeroActions>
