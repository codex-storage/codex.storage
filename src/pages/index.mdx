...
<Hero size="large" verticalAlign="center">
  <HeroInfo hideScrollToBottom>
    <HeroTitle uppercase={false}>
      Defend Against Data Censorship.<br/>Join the Codex Testnet.
    </HeroTitle>
    <HeroDescription>
    ...
    <HeroActions>
      <HeroAction
        ...
        target="_blank"
        onClick={() => umami.track('Join Testnet', { source: 'hero' })}
      >
        Join Testnet
      </HeroAction>
    </HeroActions>
    <p className='hero-note'>Note: Codex is in Alpha testing, "There be dragons" - the purpose of this testnet is to invite the community to help us build and test Codex. Data in the testnet is vulnerable to being wiped out without notice. </p>
  </HeroInfo>
  <HeroAsset>
...
<Box top={{ xs: 144, lg: 190 }}>
  <Roadmap
    ...
    description="Codex is actively operating its public non-incentivized testnet and is on track to launch its incentivized testnet in Q2 2025 followed by the mainnet launch in Q4 2025."
    href="/about/roadmap"
